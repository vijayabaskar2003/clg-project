<?php
    ...
    if(isset($_POST["login"])){
        ...
        $q="select * from caccount where companyname='$companyname' and password='$password'";
        $result=mysqli_query($conn, $q);
        if(mysqli_num_rows($result)>0){		
			$_SESSION['companyname'] = $companyname;
			$_SESSION['password'] = $password;
			$_SESSION['status']="User $companyname has logged-in successfully";
				header("location: cmodule.php");
        	}
        else{
...
<html>
    ...
    <table>
		<tr>
            ...
            <td><a href="cregister.php"> <img class="register" src="register.png"></a></td>
		</tr>
	</table>
